...
if(isset($_POST["state_id"]) && !empty($_POST["state_id"])){
    ...
    $query = $db->query("SELECT distinct route_id,route_id FROM intermediate_station WHERE inter_station = '$d' and start_place='$d10'");
...
//    $d=$row1["route_id"];}
//    else{$d="167";}
  $query = $db->query("SELECT bus_id,name FROM bus WHERE route_id = '$t'");
